...
$create = "CREATE TABLE Films (ID TINYINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, Titre VARCHAR(100), Synopsis VARCHAR(1000), Realisateur VARCHAR(50), Movie_ID TINYINT, Type VARCHAR(1), Type_video VARCHAR(5), Video_ID VARCHAR(15), Relyear DATE) ENGINE=InnoDB;
        CREATE TABLE Series (ID TINYINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, Titre VARCHAR(100), Synopsis VARCHAR(1000), Realisateur VARCHAR(50), Movie_ID TINYINT, Type VARCHAR(1), Type_video VARCHAR(5), maincharac VARCHAR(50), Relyear DATE) ENGINE=InnoDB;
        ...
        INSERT INTO Series (Titre, Synopsis, Realisateur, Movie_ID, Type, Type_video, maincharac, Relyear) VALUES ('Black Mirror', 'Black Mirror est une anthologie télévisée britannique, créée par Charlie Brooker. D’abord diffusée sur Channel 4 de 2011 à 2014, elle a connu un succès international et sa troisième saison est produite par Netflix en 2016.', 'Charlie Brooker', '3', '1', 'Serie', 'No Main Character', '2011-12-04'), ('Breaking Bad', 'Breaking Bad ou Breaking Bad : Le Chimiste au Québec est une série télévisée américaine en 62 épisodes de 47 minutes, créée par Vince Gilligan, diffusée simultanément du 20 janvier 2008 au 29 septembre 2013 sur AMC', 'Vince Gilligan', '1', '1', 'Serie', 'Bryan Cranston, Aaron Paul', '2011-01-20');
        INSERT INTO Films (Titre, Synopsis, Realisateur, Movie_ID, Type, Type_video, Video_ID, Relyear) VALUES ('Insaisissable',  'Insaisissables est un film policier franco-américain de Louis Leterrier, sorti en 2013.', 'Louis Leterrier', '1', '0', 'Film', 'FeFz-cXILA','2013-09-03'), ('Les Animaux Fantastiques', 'Les Animaux fantastiques est un film fantastique américano-britannique réalisé par David Yates, sorti en novembre 2016 au cinéma. Il s agit d une série dérivée de la saga Harry Potter qui sera suivie par quatre autres films. J. K.', 'David Yates', '2', '0', 'Film', 'jC8xuFcMq20' ,'2016-11-16');
