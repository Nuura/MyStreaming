...
$create = "CREATE TABLE Films (ID TINYINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, Titre VARCHAR(100), Synopsis VARCHAR(1000), Realisateur VARCHAR(50), Movie_ID TINYINT, Type_video VARCHAR(5), Video_ID VARCHAR(15), maincharac VARCHAR(50), Relyear DATE) ENGINE=InnoDB;
        ...
        CREATE TABLE Comment (ID TINYINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, Movie_ID TINYINT UNSIGNED , Comment VARCHAR(200), Notes TINYINT UNSIGNED, Relyear DATE) ENGINE=InnoDB;
        ...
        INSERT INTO Films (Titre, Synopsis, Realisateur, Movie_ID,  Type_video, Video_ID, maincharac, Relyear) VALUES ('Insaisissable',  'Insaisissables est un film policier franco-américain de Louis Leterrier, sorti en 2013.', 'Louis Leterrier', '1', 'Film', 'LCrRcctYEf4', ' Eddie Redmayne, Katherine Waterston, Dan Fogler', '2013-09-03'), ('Les Animaux Fantastiques', 'Les Animaux fantastiques est un film fantastique américano-britannique réalisé par David Yates, sorti en novembre 2016 au cinéma. Il s agit d une série dérivée de la saga Harry Potter qui sera suivie par quatre autres films. J. K.', 'David Yates', '2', 'Film', 'jC8xuFcMq20', 'Jesse Eisenberg, Mark Ruffalo, Woody Harrelson' ,'2016-11-16'), ('Princesse Mononoke', 'L histoire se deroule dans le Japon medieval. Ashikata, le prince de le tribu Emishis est frappé d une malédiction apres avoir tué Nago, un dieu sanglier devenu démon : Son bras est animé d une force surnaturelle mais est rongé par l entité démoniaque. La chamane du village le dit condamné a mourir et lui conseille de quitter le village, afin d aller chercher a l ouest la cause de la colere de la nature et l espoir de trouver la raison de sa malediction', 'Hayao Miyazaki', '4', 'Film', 'pkWWWKKA8jY', 'Pas d acteur principal', '2000-01-12');
        INSERT INTO Comment (Movie_ID, Comment, Notes, Relyear) VALUES ('1', 'Tres bon film', '20', NOW());
        INSERT INTO Categories (categorie_ID, Libelle) VALUES ('1', 'Thriller'), (2, 'Fantastique'), (3, 'Science-Fiction'),(4, 'Animation');
        ";
$bdd->exec($create);
?>
